...
function Dashboard() {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (gender) => {
                return (
                    gender === "male" ? <Tag color='#2d38b6'>
                        {gender}
                    </Tag> : <Tag color='#eb2f96'>
                        {gender}
                    </Tag>)
            }
            ...
            >
                 ...
                 <Row className='dashboard'>
                     {data.map((items,i ) => {
                         return (
                             <div>
                                 <Col  key={items.id} className='user' >
                                     <Card className='outercard'>
                                         ...
                                         <Row justify={'center'} className='userOption'>
                                             <Col>
                 ...
                 :
          <Table 
             columns={columns} dataSource={data} className='tabel noHover' />
