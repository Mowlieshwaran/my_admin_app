...
import { Button, Layout, Row, Col, Menu, Image, Tooltip, theme, notification } from 'antd';
                    ...
                    {!collapsed ?
                        <>
                            ...
                            <Col className='imagename'>
                                <Tooltip title={layoutselector.first_name} placement="topLeft"  >
                                    <Col  >  {layoutselector.first_name} {layoutselector.last_name}</Col>
                                </Tooltip>
                                <Tooltip title={layoutselector.email} placement="topLeft"  >
                                    <Col   >{layoutselector.email}</Col>
                                </Tooltip>
                            </Col>
