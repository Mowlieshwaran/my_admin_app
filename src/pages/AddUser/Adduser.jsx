...
import { Form, Radio, Input, Col, notification, Image, Row, Select, Button  } from 'antd';
            ...
            <Row>
                ...
                <Col span={24}>
                    ...
                    >
                        ...
                        <Row className='AlignmentCenter' justify={'space-evenly'}  >
                            <Col span={9}>
                                <Form.Item
                        ...
                        <Row justify={'space-evenly'}  >
                            ...
                            <Col span={9}>
                                <Row>
                                    ...
                                    <Col >
                                        <Button className="file_margin inputimage" disabled={upload && uploadImage} onClick={uploadImageFunction} >Upload</Button>
                                    </Col>
                                </Row>
                            </Col>
                        ...
                        <Row justify={'space-between'} className='formlastrow' >
                            <Col span={1}></Col>
                            <Col span={7}>
                                <Form.Item
